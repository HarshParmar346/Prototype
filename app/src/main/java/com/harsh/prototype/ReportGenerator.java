...
public class ReportGenerator {
    ...
    CollectionReference ref = db.collection("users").document(GoogleSignIn.getLastSignedInAccount(context).getEmail())
            .collection("Days");
    ...
    ref.document("Total").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
        ...
        public void onSuccess(DocumentSnapshot documentSnapshot) {
            ...
            mHandler.postDelayed(makeTable,5000);

            mHandler.postDelayed(generate,10000);
